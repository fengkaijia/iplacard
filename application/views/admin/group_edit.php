	...
	<div class="col-md-3">
		<div class="panel panel-default">
			...
			<div class="panel-body"><?php if($action == 'edit') { ?>
				<p>您可以通过此页面修改代表团的名称。</p>
				<p style="margin-bottom: 0;">团队领队可在对应的代表资料页面中设置。</p>
				<?php } else { ?>
				<p>您可以通过此页面添加代表团。</p>
				<p style="margin-bottom: 0;">团队领队可在对应的代表资料页面中设置。</p>
			<?php } ?></div>
			...
			echo form_open("group/delete/{$group['id']}", array(
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>您将删除<?php echo icon('group', false).$group['name'];?>代表团。该代表团中的所有代表将会转换为个人代表。请输入您的登录密码并点击确认删除按钮继续操作。</p>
