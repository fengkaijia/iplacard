		...
		<?php echo form_open_multipart('admin/export/download', array('class' => 'well form-horizontal'));?>
			<?php echo form_fieldset('数据源'); ?>
				...
				<div class="form-group <?php if(form_has_error('source')) echo 'has-error';?>">
					...
					<div class="col-lg-5">
						<?php
						echo form_dropdown_multiselect('source[]', $source, set_value('source'), false, array(), array(), array(), array(), 'selectpicker', 'title="基本信息" data-selected-text-format="count > 1" data-width="100%"');
