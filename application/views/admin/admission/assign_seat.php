...
<?php if($interview['status'] == 'completed' && !$score_level) { ?><p>代表于 <em><?php echo date('Y-m-d H:i', $interview['finish_time']);?></em> 通过面试，面试得分为 <strong><?php echo round($interview['score'], 2);?></strong>，满分为 <?php echo $score_total;?> 分。</p><?php }
