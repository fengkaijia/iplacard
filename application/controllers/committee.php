		...
		if($action == 'list')
		{
			...
			if($ids)
			{
				foreach($ids as $id)
				{
					...
					$dais_text = $dais_count.' 位主席<a href="#" class="dais_list" data-html="1" data-placement="right" data-trigger="click" data-original-title="主席团列表" data-toggle="popover" data-content=\''.$dais_list.'\'>'.icon('plus-square-o', false).'</a>';
