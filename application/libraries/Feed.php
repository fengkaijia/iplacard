...
class Feed
{
	...
	function parse()
	{
		...
		if(!$all = $this->CI->cache->get(IP_CACHE_PREFIX.'_'.IP_INSTANCE_ID.'_rss_'.$this->feed_sum))
		{
			...
			$this->CI->cache->save(IP_CACHE_PREFIX.'_'.IP_INSTANCE_ID.'_rss_'.$this->feed_sum, $all, $this->cache_life);
		}
		$this->data = $all;
		return true;
	}
